...
export default (app: Application) => {
  ...
  */
   ...
   * 分类管理
   */
  router.post('/creatclassification', controller.everydaywords.creatclassification);
  router.post('/classificationList', controller.everydaywords.classificationList);
